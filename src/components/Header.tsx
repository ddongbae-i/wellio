...
export function Header({
  ...
  return (
    <header className="fixed top-0 left-0 right-0 z-40 px-5 xs:px-5 sm:px-8 py-4 flex items-center justify-between gap-4 mx-auto h-16 max-w-[500px] bg-[#f7f7f7]/80 backdrop-blur-xs">
      {/* --- 왼쪽: 로고 --- */}
