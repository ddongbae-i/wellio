            ...
            {filteredPosts.map((post) => {
              ...
              return (
                <div
                  ...
                  className={`flex flex-col items-center w-full gap-4 py-5 xs:py-6 sm:py-8 snap-start snap-always ${isKeyboardVisible ? "justify-start pt-[120px]" : "justify-start pt-[200px]"
                    }`}
                  key={post.id}
                  style={{
                    height: cardHeight,
