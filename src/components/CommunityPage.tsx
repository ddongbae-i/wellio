      ...
      >
        {isReactionView ? (
          ...
          <div
            ...
            className={`w-full px-5 xs:px-6 sm:px-8 overflow-y-auto h-full scrollbar-hide snap-y snap-mandatory ${isKeyboardVisible ? "pb-5" : ""
              }`}
          >
            {filteredPosts.map((post) => {
              ...
              return (
                <div
                  ...
                  className={`flex flex-col items-center w-full gap-4 py-5 xs:py-6 sm:py-8 snap-start snap-always ${isKeyboardVisible ? "justify-start pt-[100px]" : "justify-center"
                    }`}
                  key={post.id}
                  style={{
                    height: cardHeight,
