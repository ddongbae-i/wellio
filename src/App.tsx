  ...
  useEffect(() => {
    ...
    const updatePosition = () => {
      ...
      if (messageBubbles) {
        ...
        messageBubbles.style.maxHeight = "55px";
  ...
  const [sampleReviews, setSampleReviews] = useState<Review[]>(() => {
    ...
    const reviewTemplates = [
      ...
      },
      {
        ...
        hospitalName: "매일건강의원",
        rating: 5,
        keywords: ["재진료 희망해요", "친절해요", "과잉진료가 없어요"],
      ...
      },
      {
        ...
        hospitalName: "매일건강의원",
        rating: 4,
        keywords: ["시설이 깨끗해요", "재진료 희망해요", "진료 만족해요"],
